...
function CategoryCreate() {
    ...
    //title page
    document.title = "Add New Category - Administrator Travel Ilzah";
                        ...
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            ...
                            <div className="card-body">
                                <form onSubmit={storeCategory}>
                                    <div className="mb-3">
                                        <label className="form-label fw-bold" for="formFile">Image</label>
                                        <input type="file" name="input"  className="form-control"  onChange={(e) =>{
